import app/models/item.{type TodoItem, Completed, Uncompleted}
import gleam/list
...
pub fn root(items: List(TodoItem)) -> Element(t) {
  div([class("app")], [
...
fn todos(items: List(TodoItem)) -> Element(t) {
  div([class("todos")], [
    todos_input(),
...
fn item(item: TodoItem) -> Element(t) {
